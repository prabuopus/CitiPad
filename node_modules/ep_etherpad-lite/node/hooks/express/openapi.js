...
const info = {
  title: 'CitiPad API',
  description:
    'CitiPad is a real-time collaborative editor scalable to thousands of simultaneous real time users. It provides full data export capabilities, and runs on your server, under your control.',
  termsOfService: 'https://www.citigroup.com/',
  contact: {
    name: 'The CitiPad Foundation',
