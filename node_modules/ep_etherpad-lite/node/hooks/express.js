...
exports.createServer = function () {
  ...
  serverName = `CitiPad ${settings.getGitCommit()} (https://www.citigroup.com)`;

  console.log(`Your CitiPad version is ${settings.getEpVersion()} (${settings.getGitCommit()})`);

  exports.restartServer();

  if (settings.ip === "") {
    // using Unix socket for connectivity
    console.log(`You can access your CitiPad instance using the Unix socket at ${settings.port}`);
  } else {
    console.log(`You can access your CitiPad instance at http://${settings.ip}:${settings.port}/`);
  }
  ...
  if (env !== 'production') {
    console.warn("CitiPad is running in Development mode.  This mode is slower for users and less secure than production mode.  You should set the NODE_ENV environment variable to production by using: export NODE_ENV=production");
  }
}
